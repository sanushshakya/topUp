    ...
    <div className='footer'>
        <div className="container">
            ...
            <div className="center">
              <h3>Follow Us On</h3>
              <div className="icons">
                <Link className='link' to='https://www.facebook.com/esportscards?mibextid=ZbWKwL'><FontAwesomeIcon icon={faFacebook} style={{color: "#ffffff",}} /></Link>
                <Link className='link' to='https://www.instagram.com/theesportscards/?igshid=OGQ5ZDc2ODk2ZA%3D%3D'><FontAwesomeIcon icon={faInstagram} style={{color: "#ffffff",}} /></Link>
